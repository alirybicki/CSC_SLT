function c = tapas_rw_reward_unrew_vol_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_rw_reward_unrew_vol';
...
% Alpha
c.logit_alunrew_v_mu = tapas_logit(0.2, 1);
c.logit_alunrew_v_sa = 1;

c.logit_alrew_v_mu = tapas_logit(0.2, 1);
c.logit_alrew_v_sa = 1;

c.logit_alunrew_s_mu = tapas_logit(0.2, 1);
c.logit_alunrew_s_sa = 1;

c.logit_alrew_s_mu = tapas_logit(0.2, 1);
c.logit_alrew_s_sa = 1;

% Gather prior settings in vectors
c.priormus = [
    c.logitv_0mu,...
    c.logit_alunrew_v_mu,...
    c.logit_alrew_v_mu,...
    c.logit_alunrew_s_mu,...
    c.logit_alrew_s_mu,...
         ];
     
c.priorsas = [
    c.logitv_0sa,...
    c.logit_alunrew_v_sa,...
    c.logit_alrew_v_sa,...
    c.logit_alunrew_s_sa,...
    c.logit_alrew_s_sa,...
 
         ];

% Model function handle
c.prc_fun = @tapas_rw_reward_unrew_vol;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_rw_reward_unrew_vol_transp;
