function r = tapas_fitModel_rew_unrew_singleLR_vol(responses, inputs, vol, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
r.c_prc = tapas_rw_reward_unrew_vol_config;%tapas_hgf_binary_config;
...
r.c_obs = tapas_softmax_binary_config;%tapas_unitsq_sgm_config;
