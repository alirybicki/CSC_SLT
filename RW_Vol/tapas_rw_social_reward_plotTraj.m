...
% Plot
plot(0:t, [r.p_prc.vr_0; r.traj.v_r], 'b', 'LineWidth', 2);
hold all;
plot(0:t, [r.p_prc.va_0; r.traj.v_a], 'r', 'LineWidth', 2);
...
if ~isempty(find(strcmp(fieldnames(r),'y'))) && ~isempty(r.y)
    ...
    title(['Response y (orange), input u (green), and value v card (blue), advice (red) for alpha_card=', ...
