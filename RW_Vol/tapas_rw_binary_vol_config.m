function c = tapas_rw_binary_vol_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
c.logitv_0sa = 0; % 0 for fixed, 1 for unfixed

% Alpha
c.logit_als_mu = tapas_logit(0.2, 1);
c.logit_als_sa = 1;

c.logit_alv_mu = tapas_logit(0.2, 1);
c.logit_alv_sa = 1;
...
c.prc_fun = @tapas_rw_binary_vol;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_rw_binary_vol_transp;
