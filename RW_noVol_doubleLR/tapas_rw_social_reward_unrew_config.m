function c = tapas_rw_social_reward_unrew_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_rw_social_reward_unrew';
...
% Alpha
c.logit_alunrew_rmu = tapas_logit(0.2, 1);
c.logit_alunrew_rsa = 1;

c.logit_alrew_rmu = tapas_logit(0.2, 1);
c.logit_alrew_rsa = 1;

c.logit_alunrew_amu = tapas_logit(0.2, 1);
c.logit_alunrew_asa = 1;

c.logit_alrew_amu = tapas_logit(0.2, 1);
c.logit_alrew_asa = 1;
...
c.prc_fun = @tapas_rw_social_reward_unrew;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_rw_social_reward_unrew_transp;
