function r = tapas_fitModel(responses, inputs,advice, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
r.c_prc = tapas_rw_social_reward_config;%tapas_hgf_binary_config;
...
r.c_obs = rw_softmax_social_reward_config;%tapas_unitsq_sgm_config;
