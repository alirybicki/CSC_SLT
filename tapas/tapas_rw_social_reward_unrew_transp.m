function [pvec, pstruct] = tapas_rw_social_reward_unrew_transp(r, ptrans)
% --------------------------------------------------------------------------------------------------
...
pstruct.al_unrew_r  = pvec(2);
pvec(3)       = tapas_sgm(ptrans(3),1); % alpha_r_volatile
pstruct.al_rew_r  = pvec(3);
...
pstruct.al_unrew_a  = pvec(5);
pvec(6)       = tapas_sgm(ptrans(6),1); % alpha_a_volatile
pstruct.al_rew_a  = pvec(6);
return;