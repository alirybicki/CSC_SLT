...
function r = tapas_fitModel_vol_social(responses, inputs, vol, advice, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
r.c_prc = tapas_rw_social_reward_vol_config;
...
trialLogLls = obs_fun(r, infStates, ptrans_obs); %AR everything same until here
