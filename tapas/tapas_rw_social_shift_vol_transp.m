function [pvec, pstruct] = tapas_rw_social_shift_vol_transp(r, ptrans)
% --------------------------------------------------------------------------------------------------
...
pvec(4)       = tapas_sgm(ptrans(4),1); % alpha_r_volatile
pstruct.al_shift_s_r  = pvec(4);
pvec(5)       = tapas_sgm(ptrans(5),1); % alpha_r_volatile
