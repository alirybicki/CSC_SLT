function c = tapas_rw_social_reward_unrew_vol_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_rw_social_reward_unrew_vol';
...
% Alpha
c.logit_alunrew_v_rmu = tapas_logit(0.2, 1);
c.logit_alunrew_v_rsa = 1;

c.logit_alrew_v_rmu = tapas_logit(0.2, 1);
c.logit_alrew_v_rsa = 1;

c.logit_alunrew_v_amu = tapas_logit(0.2, 1);
c.logit_alunrew_v_asa = 1;

c.logit_alrew_v_amu = tapas_logit(0.2, 1);
c.logit_alrew_v_asa = 1;

c.logit_alunrew_s_rmu = tapas_logit(0.2, 1);
c.logit_alunrew_s_rsa = 1;

c.logit_alrew_s_rmu = tapas_logit(0.2, 1);
c.logit_alrew_s_rsa = 1;

c.logit_alunrew_s_amu = tapas_logit(0.2, 1);
c.logit_alunrew_s_asa = 1;

c.logit_alrew_s_amu = tapas_logit(0.2, 1);
c.logit_alrew_s_asa = 1;

% Gather prior settings in vectors
c.priormus = [
    c.logitvr_0mu,...
    c.logit_alunrew_v_rmu,...
    c.logit_alrew_v_rmu,...
    c.logit_alunrew_s_rmu,...
    c.logit_alrew_s_rmu,...
    c.logitva_0mu,...
    c.logit_alunrew_v_amu,...
    c.logit_alrew_v_amu,...
    c.logit_alunrew_s_amu,...
    c.logit_alrew_s_amu,...
         ];

c.priorsas = [
    c.logitvr_0sa,...
    c.logit_alunrew_v_rsa,...
    c.logit_alrew_v_rsa,...
    c.logit_alunrew_s_rsa,...
    c.logit_alrew_s_rsa,...
    c.logitva_0sa,...
    c.logit_alunrew_v_asa,...
    c.logit_alrew_v_asa,...
    c.logit_alunrew_s_asa,...
    c.logit_alrew_s_asa,...
         ];

% Model function handle
c.prc_fun = @tapas_rw_social_reward_unrew_vol;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_rw_social_reward_unrew_vol_transp;
