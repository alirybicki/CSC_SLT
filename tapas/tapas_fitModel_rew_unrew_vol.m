...
function r = tapas_fitModel_rew_unrew_vol(responses, inputs, vol, advice, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%                        ignored. However, thå trial as such will not be ignored and filtering will
...
r.c_prc = tapas_rw_social_reward_unrew_vol_config;
