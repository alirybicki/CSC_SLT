...
%         
%         j = find(r.advice==0);%
%         x_a(j,1) = 1-x_a(j,1); % use learned value of utility of advice to weight the advice that was provided on each trial
%         b = ze1.*x_a + (1-ze1).*x_r;
%         
%     case 2
%         
%         j = find(r.advice==1);%not sure which this should be
%         x_r(j,1) = 1-x_r(j,1);
%         b = ze1.*x_r + (1-ze1).*x_a;
% end
